...
import sys
import numpy as np
from app01.amp.approximate_minima_perturbation import ApproximateMinimaPerturbationLR, \
    ApproximateMinimaPerturbationSVM
from app01.amp.common import compute_multiclass_counts
import matplotlib
...
import app01.shapley.Shapley as Shapley
...
def amp_shapley_main(chose_dataset, shapley_mode, all_eps_list, budget, bp, ps, num_repeats=None):
    ...
    return ret,global_results

def amp_shapley_main2(chose_dataset, shapley_mode, all_eps_list, budget, bp, ps, num_repeats=None):
    print("Starting...")
    np.seterr(over='ignore')
    ...
    training_subset_features_dic, training_subset_labels_dic, coverage, total = Shapley.main2(training_SV,
                                                                                             training_features,
                                                                                             testing_features,
                                                                                             training_labels,
                                                                                             testing_labels,
