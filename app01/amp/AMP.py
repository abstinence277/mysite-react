...
from app01.amp.common import compute_classification_counts, compute_multiclass_counts
...
def amp_main(chose_dataset, all_eps_list, num_repeats=None):
    ...
    elif chose_dataset == 'iris':
        training_features, testing_features, training_labels, testing_labels = Shapley.loadIris_()
    else:
