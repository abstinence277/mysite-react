    ...
    render() {
        ...
        return (
            <div style={{marginTop:'0.4rem'}}>
                ...
                <div style={{padding:'4% 0%',marginLeft:'3rem'}}>
                    <div className="inputLine">
                        {/* <p className="inputP">Total Budget ：</p> */}
                        <p className="inputP2">总预算 ：</p>
                        <InputNumber className="inputNumber2" size="small" min={0} step={0.01} precision={2}
                    ...
                    <div className="inputLine">
                        ...
                        <p className="inputP2">覆盖期望值 ：</p>
                        <InputNumber className="inputNumber2" size="small" min={0} step={0.01} defaultValue={covexp}
                            onChange={this.onChangeCE} />
                    </div>
                    <div className="inputLine">
                        {/* <p className="inputP">Coverage Sensitivity ：</p> */}
                        <p className="inputP2">覆盖敏感度 ：</p>
                        <InputNumber className="inputNumber2" size="small" min={0} step={0.01} defaultValue={covsen}
                            onChange={this.onChangeCS} />
                    </div>
                    <div className="inputLine">
                        {/* <p className="inputP">Noise Expectation ：</p> */}
                        <p className="inputP2">噪声期望值 ：</p>
                        <InputNumber className="inputNumber2" size="small" min={0} step={0.01} defaultValue={noiexp}
                            onChange={this.onChangeNE} />
                    </div>
                    <div className="inputLine">
                        {/* <p className="inputP">Noise Sensitivity ：</p> */}
                        <p className="inputP2">噪声敏感度 ：</p>
                        <InputNumber className="inputNumber2" size="small" min={0} step={0.01} defaultValue={noisen}
